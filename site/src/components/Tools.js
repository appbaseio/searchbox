              ...
              <li className="button">
                ...
                >
                  <img
                    src={
                      isVue
                        ? '../../searchbox/images/supportDark.svg'
                        : '../../searchbox/images/support.svg'
                    }
                    style={{ marginRight: 8 }}
                    alt="support"
                  />{' '}
          ...
          >
            <Layout>
              ...
              >
                ...
                <div>
                  <img
                    src="images/tools/Vue.svg"
                    alt="Reactivesearch for Vue.js"
                  />
                  <p className={brand}>
              ...
              >
                ...
                >
                  ...
                  <ul className={featureList}>
                    <li>
                      20+ pre-built React UI components with configurable styles
                      and queries.
                    </li>
              ...
              >
                ...
                >
                  ...
                  <ul className={featureList}>
                    ...
                    >
                      Works with ReactiveSearch components, and adds geospatial
                      components for Maps.
                    </li>
                    <li
                      style={{
