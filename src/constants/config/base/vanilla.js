export default {
  ...
  urls: {
    github:
      'https://github.com/appbaseio/searchbox/tree/master/packages/searchbox',
    ...
    },
    {
      ...
      list: [
...

        {
          title: 'Searchbase',
          href:
            'https://docs.appbase.io/docs/reactivesearch/searchbase/overview/QuickStart/',
          openWithTab: true
        }
      ]
    },
